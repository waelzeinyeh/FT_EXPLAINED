...
def del_freq():
    ...
    if session["msg_check"]=="Messages:On":
        session["message"]="""When hydrogen nuclei (protons) in a molecule are excited with a radiofrequency pulse, they can induce a current in the receiver coil, which leads to a radiofrequency signal (the resonance signal). This resonance signal will decay because of spin-spin relaxation.
